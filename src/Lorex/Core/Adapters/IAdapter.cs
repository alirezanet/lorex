...
public interface IAdapter
{
    ...
    /// <summary>Returns the native projection surface lorex should maintain for the adapter and artifact kind.</summary>
    AdapterProjection? GetProjection(string projectRoot, ArtifactKind kind);
